...
- 服务器Database配置：
  ...
  docker cp caddy:/data/caddy/pki/authorities/local/root.crt /opt/caddy/enigmaDatabase.crt
  ls -l /opt/caddy/enigmaDatabase.crt
  openssl x509 -in /opt/caddy/enigmaDatabase.crt -noout -subject -issuer -fingerprint -sha256
  #7、网络测试
  curl -vk --resolve enigma.database.com:443:127.0.0.1 https://enigma.database.com/
  ```
